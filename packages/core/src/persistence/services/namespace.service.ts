...
export class NamespacesService {
    ...
    async create(createNamespaceDto: NamespaceCreateInterface): Promise<NamespaceEntity> {
        ...
        if (namespace) {
            ...
            if (createNamespaceDto.projectId) {
                namespace.projects.push({ id: createNamespaceDto.projectId } as ProjectEntity);
            }
        } else {
            ...
            if (createNamespaceDto.projectId) {
                namespace.projects = [{ id: createNamespaceDto.projectId } as ProjectEntity];
            }
        }
