...
describe('LoadDocumentTool', () => {
    ...
    const mockDocuments: DocumentEntity[] = [
        { id: 'doc1', name: 'Document 1', type: 'text', content: 'content1' } as unknown as DocumentEntity,
        { id: 'doc2', name: 'Document 2', type: 'text', content: 'content2' } as unknown as DocumentEntity,
        { id: 'doc3', name: 'Document 3', type: 'pdf', content: 'content3' } as unknown as DocumentEntity,
    ];
    ...
    beforeEach(async () => {
        ...
        loadDocumentTool.applyFilters = jest.fn().mockImplementation((options, docs) => docs);
    });
    ...
    describe('getDocumentsByQuery', () => {
        ...
        it('should use getOne when many is false', async () => {
            ...
            // Act
            const result = await loadDocumentTool.getDocumentsByQuery(options, mockProcessState);
        ...
        it('should call applyFilters with options and documents', async () => {
            ...
            // Assert
            expect(loadDocumentTool.applyFilters).toHaveBeenCalledWith(options, mockDocuments);
        });
    });
});