...
jest.mock('@loopstack/shared/dist/utils/create-hash.util', () => ({
    createHash: jest.fn(),
}));
...
describe('LoadDocumentTool', () => {
    ...
    describe('updateWorkflowDependenciesIfChanged', () => {
        ...
        it('should return false when dependencies have not changed', () => {
            ...
            // Act
            const result = loadDocumentTool.updateWorkflowDependenciesIfChanged(mockProcessState, newDependencies);

            // Assert
            expect(lodash.isEqual).toHaveBeenCalledWith(['1', '2'].sort(), ['1', '2'].sort());
        ...
        it('should update dependencies and hash when dependencies have changed', () => {
            ...
            // Assert
            expect(lodash.isEqual).toHaveBeenCalledWith(['1', '2'].sort(), ['1', '3'].sort());
        ...
        it('should handle undefined workflow gracefully', () => {
            ...
            // Act & Assert
            expect(() => {
                loadDocumentTool.updateWorkflowDependenciesIfChanged(mockProcessStateWithoutWorkflow, newDependencies);
            }).toThrow();
        });
    });
});