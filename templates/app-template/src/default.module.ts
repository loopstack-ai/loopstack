...
@Module({
  imports: [LoopCoreModule, CreateChatMessageToolModule, MeetingNotesExampleModule, ChatExampleModule, PromptExampleModule, PromptStructuredOutputExampleModule, ToolCallingExampleModule, WorkflowStateExampleModule, DynamicRoutingExampleModule, CustomToolModule, ToolResultsExampleModule, RunSubWorkflowExampleModule, TestUiDocumentsExampleModule, SecretsExampleModule, SandboxExampleModule, GoogleExampleModule, GitHubExampleModule],
