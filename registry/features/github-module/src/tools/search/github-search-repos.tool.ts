...
/**
 * Zod schema for the success shape of {@link GitHubSearchReposResult}.
 *
 * @public
 */
export const GitHubSearchReposResultSchema = z.strictObject({
  totalCount: z.number(),
  results: z.array(
    z.strictObject({
      id: z.number(),
...
@Tool({
  ...
  schema: inputSchema,
  resultSchema: GitHubSearchReposResultSchema,
  effects: 'none',
})
