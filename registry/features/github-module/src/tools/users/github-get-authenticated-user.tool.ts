...
export class GitHubGetAuthenticatedUserTool implements ToolInterface {
  ...
  async execute(_args: GitHubGetAuthenticatedUserArgs, ctx: RunContext): Promise<ToolResult> {
