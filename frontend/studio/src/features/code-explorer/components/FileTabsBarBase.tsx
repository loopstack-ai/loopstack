...
export interface FileTabsBarBaseProps {
...
export function FileTabsBarBase({
  openFiles,
  selectedFile,
  selectFile,
  closeFile,
  ...
  const handleCloseClick = (e: MouseEvent<HTMLButtonElement>, file: FileExplorerNode) => {
    e.stopPropagation();
    closeFile(file);
  };
